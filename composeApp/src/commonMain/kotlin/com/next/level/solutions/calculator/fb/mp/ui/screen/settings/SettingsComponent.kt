...
//      SettingsModelUI.Rate5Stars -> triggerSignal(Signal.Rate5Stars)
//      SettingsModelUI.Share -> triggerSignal(Signal.Share)
//      SettingsModelUI.Privacy -> navigate(AppGraph.Policy)
//      SettingsModelUI.Tos -> navigate(AppGraph.Tos)
      else -> {}
    }
  }
